...
class EmergProc2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val urduText = "آگ\n" +
                " \n" +
                "اگر ممکن ہو تو ٹرک کو محفوظ جگہ پر لے جائیں۔\n" +
                "اگر آگ بہت زیادہ نہ پھیلی ہو تو دستیاب F.Eسے آگ بجھانے کی کوشش کریں۔\n" +
                "اگر F.E سے آگ بجھانے میں ناکام ہو جائے تو جائے وقوعہ سے ہٹ جائیں۔\n" +
                "مقامی فائر بریگیڈ کو مطلع کریں۔\n" +
                "ERP کوآرڈینیٹر اور کلائنٹ کے ایمرجنسی نمبر کو فوری طور پر مطلع کریں۔\n" +
                "علاقے کو گھیرے میں لے لیں/بریگیڈ کریں۔\n" +
                "حفاظتی شنک کو گاڑی سے 50 میٹر تک مناسب طریقے سے رکھیں۔\n" +
                "لوگوں کو آگ سے دور رکھنے کی کوشش کریں۔\n"
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.ep2)
