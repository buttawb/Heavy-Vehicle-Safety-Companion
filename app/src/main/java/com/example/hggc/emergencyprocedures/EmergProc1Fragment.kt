...
class EmergProc1Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val urduText = " پروڈکٹ سپیلاج    .1 \n" +
                "گاڑی کو کسی محفوظ جگہ پر پارک کریں۔\n" +
                "کمپنی کے ایمرجنسی رسپانس کوآرڈینیٹر اور کلائنٹ ایمرجنسی نمبر کو مطلع کریں۔\n" +
                "مقامی فائر بریگیڈ کو مطلع کریں۔\n" +
                "انجن ماسٹر سوئچ کو آپریٹ کرکے برقی نظام کو بند کر دیں، اور انجن کو بند کر دیں۔\n" +
                "دستیاب وسائل کی مدد سے سپل کو کنٹرول کرنے کی کوشش کریں، جیسے کہ سپل کٹ، صابن، دوسرے ٹینک لاری ڈرائیوروں سے بھی مدد لے سکتے ہیں (اسی سڑک پر چلتے ہوئے)\n" +
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.ep1)
