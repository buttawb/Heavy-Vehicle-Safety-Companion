...
class EmergProc5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val engText = "VEHICLE BREAK DOWN E.G. MECHANICAL BREAKDOWN\n" +
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.ep5)
