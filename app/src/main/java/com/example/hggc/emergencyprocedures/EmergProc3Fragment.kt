...
class EmergProc3Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val urduText = "میڈیکل ایمرجنسی پلان\n" +
                "چھوٹی طبی ایمرجنسی کی صورت میں مثلاً چھوٹی کٹیاں، یا جلنا، فرسٹ ایڈ کٹ کی مدد سے ابتدائی طبی امداد فراہم کرتا ہے، جو گاڑی میں دستیاب ہے۔\n" +
                "•کسی بھی سنگین چوٹ کی صورت میں، قریبی ہسپتال یا ایمبولینس کو کال کریں۔\n" +
                "• زخمی شخص کو لاوارث نہ چھوڑیں۔\n" +
                "سپروائزر کو جلد از جلد مطلع کریں۔\n"
        // PDF content (replace with your actual PDF text)
        val engText = "MEDICAL EMERGENCY PLAN\n" +
                "\n" +
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.ep3)
