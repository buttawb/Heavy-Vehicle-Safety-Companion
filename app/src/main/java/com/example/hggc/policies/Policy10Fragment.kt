 ...
 */
class Policy10Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_policy10, container, false)

        // PDF content (replace with your actual PDF text)

        val urduText = "۔ کام روکنے کی پالیسی \n" +
                "۱۔ آپ کو مکمل اختیار ہے کہ کسی بھی  غیر محفوظ کام کو روک  دیں ۔   اگر آپ کام دوران یا کام کی جگہ پر کوئی  غیر محفوظ  عمل ہو رہا ہے یا کوئی   خطرہ موجود ہے جس سے نقصان ہو نے کا اندشہ ہو  تو آپ کام روک کر خطرہ کو پہلے دور کریں۔ \n"
        val engText =
            "Haji Gul Group of Companies wants all employees to immediately stop working on any situation or condition that could potentially harm or endanger human life or affect the environment.\n" +
                    "It is our stop work policy that:\n" +
                    "1. All acts / actions deemed unsafe are prohibited.\n" +
                    "2. All employees have the right to stop any work or work where there is a risk of HSEQ.\n" +
                    "3. Employees should stop work immediately and notify their immediate supervisor of the effective situation.\n" +
                    "4. Any unsafe work or operation can be resumed only after the Senior Supervisor"
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.p10)
