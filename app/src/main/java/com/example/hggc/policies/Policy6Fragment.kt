 ...
 */
class Policy6Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_policy6, container, false)

        // PDF content (replace with your actual PDF text)
        val urduText = "  ذاتی تحفظ کےا ٓلات کی پالیسی\n" +
                "۱۔ ہر ملازم  پر لازم ہے کی وہ کام کے دوران ذاتی تحفظ کے آلات  کام کی نوعیت کے مطابق پہن لے۔ ۲۔ کام کے دوران \n" +
                "ہیلمیٹ،  سیفٹی چشمہ ، سیفٹی بوٹ، یونیفارم  لازم پہن لے۔ \n" +
                "بلند مقام پر کام کرتے ہوئے سیفٹی ہارنس پہن  کر اسے ہک کر لیں۔\n"
        val engText =
            "All employees should use the following PPEs according to job requirement\n" +
                    "1. Safety Helmet\n" +
                    "2. Safety shoes\n" +
                    "3. Coverall\n" +
                    "4. Safety goggles\n" +
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.p6)
