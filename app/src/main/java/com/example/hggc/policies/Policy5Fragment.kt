 ...
 */
class Policy5Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_policy5, container, false)

        // PDF content (replace with your actual PDF text)
        val urduText = "میڈیکل پالیسی\n" +
                "۱۔ ملازمت سے پہلے تمام ڈرائیور  کامنظور شدہ لیب سے  میڈیکل  میں پاس ہو نا ضروری ہے۔ \n" +
                "۲۔ ڈرائیور پر لازم ہے کہ مندرجہ زیل ٹیسٹ پاس کرے۔\n" +
                "۱۔آنکھ \n" +
                "۲۔ سماعت\n" +
                "۳۔ جسمانی  ساخت\n" +
                "۴۔ الکحل، شراب\n" +
                ...
                "۶۔ ہیروئین (منشیات)\n"
        val engText =
            "HAJI GUL GROUP OF COMPANIES is committed to protecting the health of all its employees. Medical examination from an approved lab is an integral part of the selection process.\n" + "The following tests must be done before the driver is selected and re-tested every two years and the company is authorized to test any driver for drugs and alcohol at any time.\n" + "1. Eye examination\n" + "2. Hearing inspection\n" + "3. Physical examination\n" + "4. Blood test\n" + "5.\n" + "Opiate test\n" + "6.\n" + "Cannabinoid test and\n" + "7.\n" + "Alcohol level in the blood"
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.p5)
