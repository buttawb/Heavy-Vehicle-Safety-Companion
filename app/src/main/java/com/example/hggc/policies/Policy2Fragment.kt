...
class Policy2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val urduText = "تھکاوٹ کی پالیسی\n" +
                "جسمانی  یا ذہنی تھکاوٹ  میں گاڑی چلانا منع ہے ۔  ڈرائیور پر لازم ہے کہ رات کم از کم ۶  گھنٹے  آرام کرنے کے بعد کام شروع  کرے۔ \n" +
                "۲۔ اگر کسی موقع پر ڈرائیور کو تھکاوٹ محسوس ہو تو دوسرے ڈرائیور کو گاڑی چلانے دے یا  ۳۰ منٹ کا وقفہ لے ۔ \n"
        ...
        floatingButton.setOnClickListener {
            if (isReading) {
                ...
                if (tab_select) {
                    ...
                    mMediaPlayer = MediaPlayer.create(requireContext(), R.raw.p2)
