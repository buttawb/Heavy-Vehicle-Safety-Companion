 ...
 * Use the [Video2Fragment.newInstance] factory method to
...
class Video2Fragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        playButton.setOnClickListener {
            val videoUri =
                Uri.parse("android.resource://" + requireContext().packageName + "/" + R.raw.cpr)
    ...
    companion object {
         ...
         * @return A new instance of fragment Video2Fragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            Video2Fragment().apply {
